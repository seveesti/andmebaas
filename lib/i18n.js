...
exports.updateMenus = async function() {
	// No English available as of Mar 16, 2022.
	var header = (await request("/wp-json/menus/v1/menus/primary")).body
	var footer = (await request("/wp-json/acf/v3/options/options")).body

	var headerMenu = parseHeaderMenu(header)
	var footerMenu = parseFooterMenu(footer)

	exports.HEADER_MENUS.et = headerMenu
	exports.HEADER_MENUS.en = headerMenu
	exports.FOOTER_MENUS.et = footerMenu
	exports.FOOTER_MENUS.en = footerMenu
}
